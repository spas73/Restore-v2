...
/*
La funzione isBasketItem:
Controlla se un oggetto product ha la proprietà quantity definita.
Se sì, TypeScript sa che quel product è un Item.
Serve per disambiguare i tipi unione e lavorare in sicurezza con oggetti che possono avere più forme.
*/
